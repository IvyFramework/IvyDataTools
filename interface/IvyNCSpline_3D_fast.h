...
class IvyNCSpline_3D_fast : public IvyNCSplineCore{
protected:
  T rangeYmin;
  T rangeYmax;
  T rangeZmin;
...
public:
  ...
  IvyNCSpline_3D_fast(const IvyNCSpline_3D_fast& other, const char* name=0);
	virtual TObject* clone(const char* newname) const { return new IvyNCSpline_3D_fast(*this, newname); }
	inline virtual ~IvyNCSpline_3D_fast(){}
...
protected:
  ...
  ClassDef(IvyNCSpline_3D_fast, 3)
